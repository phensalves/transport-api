...
ActiveRecord::Schema.define(version: 2022_06_05_225522) do
  ...
  create_table "customers_operations", force: :cascade do |t|
    t.bigint "customer_id", null: false
  ...
  add_foreign_key "customers_operations", "customers"
  add_foreign_key "customers_operations", "operations"
